...
\begin{landscape}
\begin{longtable}{p{2.5cm} p{1cm} p{3.5cm} p{3cm} p{3cm} p{2cm} p{7cm}}
    ...
    S-Agents & \citeyear{Chen2024} & Emergent/Social (with task features) & High & Moderate & Excluded & Overlaps with Sid, not a distinct paradigm \\
    ...
    STEVE Series & \citeyear{Zhao2024} & Single-agent/Task-oriented & High & Low & Excluded & Not multi-agent collaboration \\
    VoyagerVision & \citeyear{Smyth2025} & Single-agent/Task-oriented & High & Low & Excluded & Not multi-agent collaboration \\
    MindForge & \citeyear{Lica2024} & Platform (multi-agent support) & High & Moderate & Excluded & Infrastructure only, not a novel paradigm \\
    MindAgent & \citeyear{Gong2023} & Single-agent/Task-oriented & High & Low & Excluded & Not multi-agent collaboration \\
\end{longtable}
\end{landscape}
