...
This study uses a comparative case study approach to analyze multi-agent collaboration in Minecraft, following established guidelines from \textcite{Yin2018CaseStudyResearchDesignMethods} and \textcite{Eisenhardt1989BuildingTheoriesFromCaseStudyResearch}. The process included: (1) identifying and screening candidate systems using explicit inclusion and exclusion criteria; (2) conducting a literature search across major academic databases; (3) applying a structured analytical framework to compare selected cases; and (4) documenting the use of generative AI tools, including ethical considerations and verification procedures. This ensures transparency, replicability, and systematic analysis.

Project Sid and TeamCraft were selected as recent, well-documented, and conceptually contrasting case studies. Other modern systems were excluded due to overlap or insufficient distinctiveness. The analytical framework compares organizational structure, communication and coordination, learning and adaptation, and sustainability and scalability, drawing on established MAS and organizational theory.
